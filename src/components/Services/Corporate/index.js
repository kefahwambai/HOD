...
export default function Corprate() {
  return (
    <div>
    <section id="abthead">
        <div className='abth1'>
    ...
    <div className='plaHead'>
          ...
          <div style={{ width: '15vw', float: 'right', marginTop: '-13rem'}}>
            <ul className="corpservice" >
                ...
                <hr style={{marginLeft: '-1rem'}}/>
                <li style={{cursor: 'pointer'}} className=""><Link style={{color: 'black', textDecoration: 'none'}} to="/weddings">WEDDINGS</Link></li>
                <hr style={{marginLeft: '-1rem'}}/>
                <li style={{cursor: 'pointer'}} className=""><Link style={{color: 'black', textDecoration: 'none'}} to="/events">EVENT PLANNING</Link></li>
                <hr style={{marginLeft: '-1rem'}}/>
                <li style={{cursor: 'pointer'}} className=""><Link style={{color: 'black', textDecoration: 'none'}} to="/parties">PARTIES</Link></li>
                <hr style={{marginLeft: '-1rem'}}/>
            </ul>
          </div>
          <img src="https://demo2.wpopal.com/grenda2/wp-content/uploads/2022/08/services-1.jpeg"/>
          <div>
